...
**Live deployment.** Contract [`0x54f4d40c68A2182ab7F67242f73Ff935C60DDeE7`](https://explorer-studio.genlayer.com/address/0x54f4d40c68A2182ab7F67242f73Ff935C60DDeE7) on chain
...
npm test              # 67 direct tests (auto-creates the python venv on first run)
...
gives **16/16 checks passed** (incl. live GenVM compile, payable schema flags &
schema-surface match); `npm run test:direct` gives **67 passed**;
...
tests/
  direct/              pytest suite: mocked-GenVM harness + 67 direct tests
scripts/
