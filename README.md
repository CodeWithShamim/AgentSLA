...
**Live deployment.** Contract [`0x8e454d511e5CBD67d364e8FE3aEff26685B0d5AB`](https://explorer-studio.genlayer.com/address/0x8e454d511e5CBD67d364e8FE3aEff26685B0d5AB) on chain
...
npm test              # 59 direct tests (auto-creates the python venv on first run)
...
schema-surface match); `npm run test:direct` gives **59 passed**;
...
vault — with the backing invariant checked after every step.
...
tests/
  direct/              pytest suite: mocked-GenVM harness + 59 direct tests
scripts/
